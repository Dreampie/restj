 ...
 */
public interface RestjResponse extends AutoCloseable {
  RestjResponse setStatus(HttpStatus i);
   ...
   */
  RestjResponse setContentType(String s);
  ...
  RestjResponse addCookie(String cookie, String value);

  RestjResponse addCookie(String cookie, String value, Duration expires);

  RestjResponse clearCookie(String cookie);

  RestjResponse setHeader(String headerName, String header);
