 ...
 */
public class StdRestjRequestMatcher implements RestjRequestMatcher {
  ...
  public StdRestjRequestMatcher(HttpMethod method, String pathPattern) {
  ...
  public Optional<? extends RestjRequestMatch> match(HttpMethod method, String path) {
    ...
    return Optional.of(new StdRestjRequestMatch(pathPattern, path, params.build()));
  }
