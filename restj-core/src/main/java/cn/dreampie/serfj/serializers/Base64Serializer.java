...
public class Base64Serializer implements ObjectSerializer {
  ...
  public String serialize(Object object) {
    ...
    try {
      ...
      return new String(BaseEncoding.base64().encode(bos.toByteArray()));
    } catch (IOException e) {
  ...
  public Object deserialize(String data) {
    ...
    try {
      bis = new ByteArrayInputStream(BaseEncoding.base64().decode(data));
  ...
  /**
   * @see cn.dreampie.serfj.serializers.Serializer#getContentType()
   */
